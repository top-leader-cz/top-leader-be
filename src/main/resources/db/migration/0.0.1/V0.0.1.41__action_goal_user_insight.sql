...
('PERSONAL_GROWTH_TIP', '
Based on the user''s top 5 strengths: {0}, selected values: {1}, chosen area for development: {2}, long-term goal: {4}, and short-term goals: {5}, here are your tailored steps to achieve each short-term goal:
...
Reflect briefly on how accomplishing this task will bring you closer to your long-term goal: {4}.
Repeat these steps for each short-term goal, maintaining focus and alignment with user’s strengths and values. Keep sentences concise and in the first person to engage directly with the user. All guidance should be in {6} language.');
