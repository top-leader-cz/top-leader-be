...
public class GoogleCalendar {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        var in = GoogleCalendar.class.getClassLoader().getResourceAsStream("google_secret.json");
        if (in == null) {
            throw new FileNotFoundException("Resource not found: " + "google_secret.json");
        }
