...
public class NativeImageConfiguration {
    ...
    static class TopLeaderRuntimeHints implements RuntimeHintsRegistrar {
        ...
        public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
            ...
            registerForJsonSerialization(hints, ProgramSummaryDto.class);
            registerForJsonSerialization(hints, ProgramDetailDto.class);
            registerForJsonSerialization(hints, ProgramStatsDto.class);
            registerForJsonSerialization(hints, ParticipantDto.class);
        }
