...
public class AiClient {
    ...
    public static final String WORLD_LEADER_PERSONA = "Given a user's top 5 strengths: %s, and key values: %s, identify three world leaders who most closely exemplify these characteristics, ensuring they come from different continents and represent diverse backgrounds. If exact matches are challenging to find, prioritize leaders who align most closely with the user's profile. Provide a brief overview of their key leadership traits, main achievements, and how their approach resonates with the described profile, excluding any dictators or controversial figures. Recommend a widely recognized book, documentary, or article for each leader, noting the title and suggesting a search for the URL. Ensure the descriptions are accurate and free from embellishments, ensuring respectful language and diverse representation. The text is to be in %s language, addressed in the second person, and stay under 800 characters.";
