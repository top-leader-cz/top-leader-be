 ...
 */
public interface ScheduledSessionRepository extends CrudRepository<ScheduledSession, Long>, PagingAndSortingRepository<ScheduledSession, Long> {
    ...
    @Query("SELECT COUNT(*) FROM scheduled_session WHERE status = :status")
