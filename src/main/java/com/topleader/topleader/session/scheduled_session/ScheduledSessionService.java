...
public class ScheduledSessionService {
    ...
    public ScheduledSessionQueryRepository.SessionSummary getSessionSummary(String username) {
        return scheduledSessionQueryRepository.getSessionSummary(username);
    }
}
