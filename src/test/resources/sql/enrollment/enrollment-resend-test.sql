-- Resend enrollment email test (CREATED program with INVITED and ACTIVE participants)
...
VALUES
    ...
    ('hr_other', 'pass', '["HR","USER"]', 'AUTHORIZED', 'UTC', 'Other', 'Hr', 200, 'hr_other@test.cz', 'en'),
    ('user1@test.cz', 'pass', '["USER"]', 'AUTHORIZED', 'UTC', 'Jan', 'Novak', 100, 'user1@test.cz', 'en'),
    ('user2@test.cz', 'pass', '["USER"]', 'AUTHORIZED', 'UTC', 'Petr', 'Svoboda', 100, 'user2@test.cz', 'en');
...
VALUES (1, 100, 'Resend Test Program', 'Test goals', 'PARTICIPANT_CHOOSES', 'CREATED', 90,
        5, NOW(), 'hr_prog', NOW(), 'hr_prog');

INSERT INTO program_participant (id, program_id, username, status, enrollment_email_sent_at, created_by, created_at)
VALUES
    (1, 1, 'user1@test.cz', 'INVITED', NOW() - INTERVAL '1 day', 'hr_prog', NOW()),
    (2, 1, 'user2@test.cz', 'ACTIVE', NOW() - INTERVAL '1 day', 'hr_prog', NOW());
...
VALUES
    (1, 100, 100, 'user1@test.cz', 5, 0, 'ACTIVE', 'hr_prog', NOW()),
    (2, 100, 100, 'user2@test.cz', 5, 2, 'ACTIVE', 'hr_prog', NOW());
