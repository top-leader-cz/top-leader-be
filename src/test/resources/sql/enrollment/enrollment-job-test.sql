-- Job endpoint test: scheduled email ready to be sent
...
VALUES (1, 100, 'Job Test Program', 'Test goals', 'PARTICIPANT_CHOOSES', 'CREATED', 90,
        5, NOW(), 'hr_prog', NOW(), 'hr_prog');

INSERT INTO program_participant (id, program_id, username, status, enrollment_email_scheduled_at, created_by, created_at)
VALUES (1, 1, 'user1@test.cz', 'INVITED', NOW() - INTERVAL '1 hour', 'hr_prog', NOW());
...
VALUES (1, 100, 100, 'user1@test.cz', 5, 0, 'ACTIVE', 'hr_prog', NOW());
