-- Today start date enrollment email test (email should be sent immediately on launch)
...
VALUES (100, 100, 'CORE', 20, 'ACTIVE', CURRENT_DATE, CURRENT_DATE + INTERVAL '90 days', 'hr_prog', NOW());
...
VALUES (1, 100, 'Today Program', 'Today goals', 'PARTICIPANT_CHOOSES', 'DRAFT', 90,
