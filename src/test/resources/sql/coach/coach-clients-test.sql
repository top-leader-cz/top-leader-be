insert into users (username, email, password, time_zone, first_name, last_name)
values ('coach', 'coach-client@gmail.com', '$2a$12$jsTVqLPSt7pqxT.sPYKZ/.y0Vd6E.thnlpAJHghoQhIYihHys6OSO', 'UTC', 'firstName', 'lastName');
...
insert into users (username, email, coach, password, time_zone, first_name, last_name)
values ('client4', 'client4@eamil.com','coach', '$2a$12$jsTVqLPSt7pqxT.sPYKZ/.y0Vd6E.thnlpAJHghoQhIYihHys6OSO', 'UTC', 'Cool', 'Client')
