...
insert into coach (username, bio, email, experience_since, first_name, last_name, photo, public_profile, rate, time_zone)
values ('coach', 'some bio', 'cool@email.cz', '2023-08-06', 'firstName', 'lastName', null, true, '$$$', 'UTC');
