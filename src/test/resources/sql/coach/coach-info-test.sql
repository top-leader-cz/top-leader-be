...
insert into coach (username, bio, experience_since, web_link, public_profile, rate, certificate, primary_roles, linkedin_profile, free_slots, priority, base_locations, travel_willingness, delivery_format, service_type, topics, diagnostic_tools, industry_experience, user_references, languages, fields)
values ('coach', 'some bio', '2023-08-06', 'http://some_video1', true, '$', '["ACC"]', '["COACH"]', 'http://linkedin.com/coach', true, 10, '["Prague", "Brno"]', 'WITHIN_COUNTRY', '["ONLINE", "HYBRID"]', '["ONE_TO_ONE", "TEAM"]', '["LEADERSHIP", "COMMUNICATION"]', '["MBTI", "DISC"]', '["TECH", "FINANCE"]', 'Experienced coach', '["cz", "aj"]', '["field1", "field2"]');
