...
insert into users (username, password, status, authorities, locale, company_id, aspired_competency, aspired_position, first_name, last_name)
values ('user3', '$2a$12$jsTVqLPSt7pqxT.sPYKZ/.y0Vd6E.thnlpAJHghoQhIYihHys6OSO', 'AUTHORIZED', '["USER"]', 'cs', 1, 'competency', 'position', 'first', 'last');
insert into users (username, password, status, authorities, locale, company_id, aspired_competency, aspired_position, first_name, last_name)
...
insert into scheduled_session(id, username, time, coach_username, paid, is_private) values (1, 'user3', now()::date - interval '10 day',  'coach', false, false);
insert into scheduled_session(id, username, time, coach_username, paid, is_private) values (1, 'user4', now()::date - interval '24 day',  'coach', false, false);
