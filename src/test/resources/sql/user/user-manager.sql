...
values ('manager.one@dummy.com', 'manager', 'one','$2a$12$jsTVqLPSt7pqxT.sPYKZ/.y0Vd6E.thnlpAJHghoQhIYihHys6OSO',  'Europe/Prague', 'AUTHORIZED', '["MANAGER", "USER"]', 'dummy position', 1);
