...
insert into coach (username, bio, experience_since, web_link, public_profile, rate, internal_rate, certificate, primary_roles, languages, fields)
values ('user1', 'some bio', '2023-08-06', 'http://some_video1', true, '$$$', 300, '["MCC", "CUSTOM"]', '["COACH","TRAINER"]', '["cz"]', '["field1"]');
