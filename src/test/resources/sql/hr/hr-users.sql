...
VALUES ('hrUser', 'password123', '["USER", "HR"]', 'PENDING', 'UTC', 'John', 'Doe', 1, 'Coach1', 100, 0, 10, 111),
       ('user1', 'password456', '["USER"]', 'AUTHORIZED', 'UTC', 'Alice', 'Smith', 1, 'Coach2', 50, 10, 20, 222),
       ('user2', 'password789', '["USER"]', 'AUTHORIZED', 'UTC', 'Bob', 'Johnson', 456, 'Coach3', 75, 25, 30, 333),
