...
INSERT INTO program (id, coaching_package_id, name, goal, coach_assignment_model, milestone_date, created_at, created_by)
VALUES (1, 100, 'Leadership Development 90d', 'Improve feedback', 'PARTICIPANT_CHOOSES',
        NOW() + INTERVAL '33 days',
...
VALUES
    (1, 1, 'tomas.novak',   'hr_prog', NOW() - INTERVAL '57 days'),
    (2, 1, 'jana.dvorak',   'hr_prog', NOW() - INTERVAL '57 days'),
    (3, 1, 'marketa.cerva', 'hr_prog', NOW() - INTERVAL '57 days'),
    (4, 1, 'oleg.volkov',   'hr_prog', NOW() - INTERVAL '57 days');
