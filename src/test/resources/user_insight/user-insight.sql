...
insert into user_insight(username, leadership_style_analysis, animal_spirit_guide, world_leader_persona, user_previews, user_articles)
values ('user', 'leadership-response', 'animal-response', 'world-leader-persona', 'test-user-previews', 'test-user-articles');
