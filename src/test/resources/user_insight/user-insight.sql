...
insert into user_insight(username, leadership_style_analysis, animal_spirit_guide, world_leader_persona)
values ('user', 'leadership-response', 'animal-response', 'world-leader-persona');
