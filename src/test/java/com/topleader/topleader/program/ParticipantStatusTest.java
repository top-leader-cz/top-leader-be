...
import com.topleader.topleader.program.dto.ParticipantDto;
...
class ParticipantStatusTest {
    ...
    private static ProgramRepository.ParticipantRow row(int consumed, int allocated) {
        return new ProgramRepository.ParticipantRow("user1", "John", "Doe", null, null, null, consumed, allocated, "ACTIVE");
    }
