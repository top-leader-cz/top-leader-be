...
class ParticipantStatusTest {
    ...
    void notStarted_whenValidFromIsNull() {
        var dto = ProgramController.ParticipantDto.from(row(0, 5), null, LocalDateTime.now().plusDays(30));
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.NOT_STARTED);
    }

    @Test
    void notStarted_whenMilestoneDateIsNull() {
        var dto = ProgramController.ParticipantDto.from(row(0, 5), LocalDateTime.now().minusDays(10), null);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.NOT_STARTED);
    }
    ...
    void notStarted_whenProgramNotYetStarted() {
        ...
        var dto = ProgramController.ParticipantDto.from(row(0, 5), validFrom, milestone);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.NOT_STARTED);
    }
    ...
    void onTrack_whenConsumedMatchesPace() {
        ...
        var dto = ProgramController.ParticipantDto.from(row(4, 6), validFrom, milestone);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.ON_TRACK);
    }
    ...
    void atRisk_whenConsumedBelowThreshold() {
        ...
        var validFrom = LocalDateTime.now().minusDays(60);
        var milestone = LocalDateTime.now().plusDays(30);
        var dto = ProgramController.ParticipantDto.from(row(1, 6), validFrom, milestone);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.AT_RISK);
    }
    ...
    void onTrack_whenZeroAllocated() {
        ...
        var dto = ProgramController.ParticipantDto.from(row(0, 0), validFrom, milestone);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.ON_TRACK);
    }
    ...
    void onTrack_atBoundary() {
        ...
        var dto = ProgramController.ParticipantDto.from(row(2, 4), validFrom, milestone);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.ON_TRACK);
    }
    ...
    void onTrack_whenProgramFullyElapsed() {
        ...
        var dto = ProgramController.ParticipantDto.from(row(4, 4), validFrom, milestone);
        assertThat(dto.status()).isEqualTo(ProgramController.ParticipantStatus.ON_TRACK);
    }
}
